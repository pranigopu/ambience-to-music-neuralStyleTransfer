...
My project explores the potential NST in a specific task, namely the transferring the timbre, texture and acoustics of one piece to the melody and harmony of another. Hence, it aims to address the problem of inferring and transferring musical features by capturing a wider variety of abstract audio features at various levels of abstractions using more layers in the CNN with smaller kernels, hence the 8 convolutional layers. Using a wider selection of layers representing potentially valuable audio features, my project gives a means to experiment with features (of the style audio especially) at varying levels of abstractions and explore the effects of considering any set of abstract features.
